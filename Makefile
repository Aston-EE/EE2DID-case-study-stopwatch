...
# (c) Dr. John A.R. Williams <j.a.r.williams@aston.ac.uk> 2018--2020
...
make <[top].bin>             - generate bin file for flash
make <[top].flash>         - programe board flash board using [top].bin
